...
from litex_boards.platforms import icefeather
...
def flash(bios_flash_offset):
    ...
    prog.flash(bios_flash_offset, "build/icefeather/software/bios/bios.bin")
    prog.flash(0x00000000,        "build/icefeather/gateware/icefeather.bin")
    exit()

# Build --------------------------------------------------------------------------------------------

def main():
    parser = argparse.ArgumentParser(description="LiteX SoC on iCEFeather")
